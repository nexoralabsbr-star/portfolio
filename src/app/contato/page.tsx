            ...
            <div className="flex flex-col gap-8 py-4">
              <div>
                ...
                <h2 className="text-3xl md:text-4xl font-semibold tracking-tighter text-zinc-900 mb-6">
                  Agende sua chamada de diagnóstico.
                </h2>
                <div className="space-y-4 text-zinc-600 text-base leading-relaxed">
                  <p>
                    Valorizamos o seu tempo tanto quanto o nosso. Ao entrar em contato, você falará diretamente com arquitetos de software e especialistas em IA.
                  </p>
                </div>
              </div>
