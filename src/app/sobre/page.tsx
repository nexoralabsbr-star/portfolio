        ...
        <main className="flex flex-col items-center justify-center mt-12 lg:mt-16 w-full gap-24 lg:gap-32">
          ...
          <section className="w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            <div className="relative">
              <div className="aspect-[4/5] rounded-3xl bg-gradient-to-br from-zinc-200 via-zinc-100 to-white border border-zinc-200 shadow-lg overflow-hidden relative">
                {/* Decorative abstract gradient in lieu of a photo */}
                <div className="absolute inset-0 bg-gradient-to-br from-orange-100/60 via-violet-100/40 to-zinc-50" />
